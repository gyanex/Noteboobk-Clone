...
var index_cjs$6 = require('../../csv/dist/index.cjs');
var index_cjs$4 = require('../../docx/dist/index.cjs');
var index_cjs$3 = require('../../html/dist/index.cjs');
var index_cjs$2 = require('../../image/dist/index.cjs');
var index_cjs$5 = require('../../markdown/dist/index.cjs');
var index_cjs$7 = require('../../pdf/dist/index.cjs');
var index_cjs = require('../../text/dist/index.cjs');
var index_cjs$1 = require('../../xml/dist/index.cjs');
...
class AbstractSimpleDirectoryReader {
    ...
    async loadData(params) {
        ...
        const { directoryPath, defaultReader = new index_cjs.TextFileReader(), fileExtToReader, numWorkers = 1, overrideReader } = params;
    ...
    async processFile(filePath, params) {
        const docs = [];
        try {
            const fileExt = env.path.extname(filePath).slice(1).toLowerCase();
...
const FILE_EXT_TO_READER = {
    txt: new index_cjs.TextFileReader(),
    pdf: new index_cjs$7.PDFReader(),
    csv: new index_cjs$6.CSVReader(),
    md: new index_cjs$5.MarkdownReader(),
    docx: new index_cjs$4.DocxReader(),
    htm: new index_cjs$3.HTMLReader(),
    html: new index_cjs$3.HTMLReader(),
    jpg: new index_cjs$2.ImageReader(),
    jpeg: new index_cjs$2.ImageReader(),
    png: new index_cjs$2.ImageReader(),
    gif: new index_cjs$2.ImageReader(),
    xml: new index_cjs$1.XMLReader()
};
/**
