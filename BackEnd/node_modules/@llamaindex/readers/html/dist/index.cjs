 ...
 */ class HTMLReader extends schema.FileReader {
    /**
   ...
   */ async parseContent(html, options = {}) {
        const { stripHtml } = await Promise.resolve().then(function () { return require('./string-strip-html.esm-DAi9znNo.cjs'); }); // ESM only
