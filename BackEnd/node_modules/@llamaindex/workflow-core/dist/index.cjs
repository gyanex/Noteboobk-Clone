...
const _executorAsyncLocalStorage = (0, __llamaindex_workflow_core_async_context.createAsyncContext)();
function getContext() {
	const context = _executorAsyncLocalStorage.getStore();
	if (!context) throw new Error("No current context found");
	return context;
}
const handlerContextAsyncLocalStorage = (0, __llamaindex_workflow_core_async_context.createAsyncContext)();
