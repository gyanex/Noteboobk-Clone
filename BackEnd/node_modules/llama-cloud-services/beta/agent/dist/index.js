import { client as client$1 } from '../../../api/dist/index.js';
 ...
 */ class AgentClient {
    constructor({ client = client$1, collection = "default", deploymentName = "_public", agentUrlId }){
        this.client = client;
 ...
 */ function createAgentDataClient({ client = client$1, windowUrl, env, deploymentName, agentUrlId, collection = "default" } = {}) {
...
export { AgentClient, StatusType as StatusTypeEnum, createAgentDataClient };
