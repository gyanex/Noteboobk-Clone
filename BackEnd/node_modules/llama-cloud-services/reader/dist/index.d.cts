...
import { ParserLanguages, ParsingMode, FailPageMode } from '../../api/dist/index.cjs';
...
declare class LlamaParseReader extends FileReader {
     ...
     */
    loadJson(filePathOrContent: string | Uint8Array): Promise<ParseResult[]>;
    /**
     ...
     * @returns A Promise that resolves to an array of ParseResult objects, encapsulating the JSON array resulting from the parsing within the pages attribute.
     */
    parse(filePathOrContent: string | Uint8Array | string[] | Uint8Array[]): Promise<ParseResult[]>;
    /**
     ...
     */
    getTables(jsonResults: ParseResult[], downloadPath: string): Promise<string[]>;
    /**
     ...
     */
    getImages(jsonResult: ParseResult[], downloadPath: string): Promise<Record<string, any>[]>;
    /**
...
export type { BackoffPattern, Language, ResultType };
