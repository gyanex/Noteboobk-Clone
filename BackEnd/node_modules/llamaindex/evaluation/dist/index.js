import { PromptTemplate, PromptMixin, defaultCondenseQuestionPrompt, defaultChoiceSelectPrompt } from '@llamaindex/core/prompts';
import { MetadataMode, ModalityType, ObjectType, Document } from '@llamaindex/core/schema';
...
import { AsyncLocalStorage, fs, path, consoleLogger, createSHA256 } from '@llamaindex/env';
import { IndexStructType, IndexList } from '@llamaindex/core/data-structs';
...
const defaultUserPrompt = new PromptTemplate({
    templateVars: [
        "query",
        "referenceAnswer",
        "generatedAnswer"
...
const defaultCorrectnessSystemPrompt = new PromptTemplate({
...
const defaultFaithfulnessRefinePrompt = new PromptTemplate({
    templateVars: [
        "query",
        "existingAnswer",
        "context"
...
const defaultFaithfulnessTextQaPrompt = new PromptTemplate({
    templateVars: [
        "context",
        "query"
    ],
...
const defaultRelevancyEvalPrompt = new PromptTemplate({
    templateVars: [
        "context",
        "query"
    ],
...
const defaultRelevancyRefinePrompt = new PromptTemplate({
    templateVars: [
        "query",
        "existingAnswer",
        "contextMsg"
...
/** Correctness Evaluator */ class CorrectnessEvaluator extends PromptMixin {
    constructor(params){
...
class FaithfulnessEvaluator extends PromptMixin {
    constructor(params){
        super();
...
class RelevancyEvaluator extends PromptMixin {
    constructor(params){
        super();
        this.raiseError = params?.raiseError ?? false;
